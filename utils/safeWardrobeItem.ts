...
export function coerceWardrobeItemForList(
  ...
  try {
    ...
    const base: WardrobeItem = {
      ...
      imagePhash: typeof row.imagePhash === 'string' ? row.imagePhash : undefined,
      sourceCropId: typeof row.sourceCropId === 'string' ? row.sourceCropId : undefined,
      cropId: typeof row.cropId === 'string' ? row.cropId : undefined,
      scanSessionId: typeof row.scanSessionId === 'string' ? row.scanSessionId : undefined,
      captureSessionId: typeof row.captureSessionId === 'string' ? row.captureSessionId : undefined,
      sourceImageId: typeof row.sourceImageId === 'string' ? row.sourceImageId : undefined,
