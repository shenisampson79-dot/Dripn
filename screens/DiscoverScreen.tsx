...
const ALL_BARGAIN_ITEMS: BargainItem[] = [
  ...
  },
  {
    id: "ath-uk3",
    brand: "Sweaty Betty",
    name: "Power Workout Leggings",
    originalPrice: 88.00,
    salePrice: 70.40,
    discountPercent: 20,
    store: "Sweaty Betty",
    storeHandle: "@sweatybetty",
    category: "Athleisure",
    icon: "activity",
    regions: [...UK_COUNTRIES, ...EU_COUNTRIES, ...US_COUNTRIES, ...AUSTRALIA_COUNTRIES],
    currency: "GBP",
  ...
  },
  {
    id: "ath-us1",
    brand: "Lululemon",
    name: "Align High-Rise Leggings",
    originalPrice: 98.00,
    salePrice: 79.00,
    discountPercent: 19,
    store: "Lululemon",
    storeHandle: "@lululemon",
    category: "Athleisure",
    icon: "activity",
  ...
  },
  {
    id: "ath-run3",
    brand: "Hoka",
    name: "Clifton 9 Running Shoes",
    originalPrice: 145.00,
    salePrice: 116.00,
    discountPercent: 20,
    store: "JD Sports",
    storeHandle: "@jdsports",
    category: "Running",
    icon: "zap",
    regions: UK_COUNTRIES,
    currency: "GBP",
