...
const COMPARISON_TIERS: DFYComparisonTier[] = [
  {
    ...
    tagline: 'A wardrobe system that keeps working for you.',
    price: '£39.99',
    mentalModel: 'structural',
    description: 'I organize up to 30 items, style you for 30 days, and save your wardrobe forever. Swap, remix, and plan ahead anytime.',
    features: [
      { text: 'Up to 30 items, categorized & tagged', included: true },
      { text: '30 styled looks over 30 days', included: true },
      { text: 'Wardrobe saved forever', included: true },
      { text: 'Swap, remix & plan seasons', included: true },
    ],
    deliveryDays: 30,
    itemLimit: 30,
    outfitCount: 30,
  ...
  },
  {
    ...
    tagline: 'Ready-to-wear looks for one moment.',
    price: '£19.99',
    mentalModel: 'tactical',
    description: '14 complete looks for a trip, event, or busy week. Wear them straight away—no wardrobe building needed.',
    features: [
      { text: '14 styled looks over 14 days', included: true },
      { text: 'One occasion (work, holiday, event)', included: true },
      { text: 'Stylist adjustments during window', included: true },
      { text: 'Save looks as reference cards', included: true },
