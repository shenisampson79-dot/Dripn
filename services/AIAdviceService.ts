  ...
  accessories: {
    ...
    luxuryBagsMen: {
      trending: [
        ...
        { brand: "Louis Vuitton", item: "District PM", style: "Structured messenger bag for polished everyday use" },
    ...
    watches: {
      ...
      mens: [
        { brand: "Rolex", item: "Submariner", style: "Robust dive watch with a recognisable sport profile" },
        { brand: "Rolex", item: "Datejust 41", style: "Classic everyday luxury - versatile" },
        { brand: "Omega", item: "Seamaster", style: "Technical sport watch with tailored versatility" },
        { brand: "Patek Philippe", item: "Nautilus", style: "Integrated-bracelet design with a slim profile" },
        { brand: "AP", item: "Royal Oak", style: "Architectural octagonal design" },
        { brand: "TAG Heuer", item: "Monaco", style: "Racing heritage - bold square case" },
      ],
      styling: [
        "A rectangular dress watch adds a precise, restrained line to tailoring or eveningwear.",
        "A steel dive watch can bridge casual and smart-casual looks when its scale suits the cuff.",
        "An integrated-bracelet watch works best when its finish supports, rather than dominates, the outfit.",
      ],
    },
  },
...
const STYLE_ADVICE_TEMPLATES = {
  general: [
    "Check the outfit in one full-length view: one silhouette anchor, a clear focal colour, and occasion-appropriate shoes should read immediately.",
    "Keep one piece as the visual lead and let the remaining colours and textures support it rather than compete.",
    "Assess the hem lengths and volume together. If both halves feel visually heavy, streamline one layer or show a cleaner break.",
    "Use the shoe and outer layer to confirm the formality. If they tell different stories, edit one rather than adding more accessories.",
    "Before adding anything, check whether the look is complete for the weather and itinerary. A practical layer often adds more than decoration.",
  ],
  casual: [
    "For credible casual styling, keep the proportions deliberate and choose footwear for the actual walking and weather involved.",
    "A clean sneaker, loafer, boot, or sandal can each work here—the right choice depends on the outfit’s material weight and occasion.",
    "If the basics feel unfinished, repeat one colour in the shoe, bag, or outer layer rather than adding an unrelated statement piece.",
    "Try the top tucked, untucked, and lightly bloused; keep the version that gives the clearest proportion with the rise of the bottom.",
    "Casual should still look resolved: check garment condition, trouser break, sock line, and whether the outer layer belongs in the same formality lane.",
  ],
  formal: [
    "Formalwear earns its polish through fit and restraint: check shoulder line, sleeve length, hem, trouser break, and shoe condition before adding extras.",
    "Keep metals and hardware consistent, then use one considered accessory only if the dress code and outfit need it.",
    "Match the shoe’s formality and visual weight to the tailoring; do not use a pointed shape or heel as a body-correction device.",
    "Confirm the exact dress code before approving the look. Business, cocktail, black tie, and ceremony dressing are not interchangeable.",
    "A formal look should be complete but not overloaded. Prioritise grooming, pressing, and clean lines over arbitrary statement details.",
  ],
  colorAdvice: [
  ...
  proportions: [
    ...
    "A fitted top with a relaxed bottom creates clear proportion contrast; check that the lengths and movement feel intentional on you.",
  ...
  seasonal: {
    ...
    fall: [
      "Warm tones and layered textures can read clearly autumnal. Add a scarf only if it supports the palette and weather.",
  ...
  sizeInclusive: [
    ...
    "An empire line creates a high focal point and fluid movement; check the fabric weight and hem for the occasion.",
  ...
  trendingNow: [
    ...
    "Barrel-leg jeans create a strong geometric silhouette; balance their volume with a deliberate top length and shoe shape.",
