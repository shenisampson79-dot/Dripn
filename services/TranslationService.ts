...
const DEFAULT_TRANSLATIONS: Translations = {
  ...
  dfy: {
    comparison: {
      ...
      occasionReadyLabel: 'Occasion Ready Label',
    ...
    start: {
      ...
      cantStartTitle: 'Cant Start Title',
      chooseIncludedPath: 'Choose Included Path',
      chooseIncludedPathDesc: 'Choose Included Path Desc',
      choosePlanUnlock: 'Choose Plan Unlock',
      compareStylistUnlimited: 'Compare Stylist Unlimited',
      dressBetterPurchase: 'Dress Better Purchase',
      fullSetupIncludedNote: 'Full Setup Included Note',
      headerDefault: 'Header Default',
      heroIncluded: 'Hero Included',
      heroUnlock: 'Hero Unlock',
      includedSetup: 'Included Setup',
      lookReadyPurchase: 'Look Ready Purchase',
      noBenefitSubtitle: 'No Benefit Subtitle',
      oneSetupNote: 'One Setup Note',
      oneTime: 'One Time',
      personalStylist: 'Personal Stylist',
      personalStylistIncludes: 'Personal Stylist Includes',
      purchaseAnother: 'Purchase Another',
      purchaseAnotherDesc: 'Purchase Another Desc',
      quickVsFullNote: 'Quick Vs Full Note',
      recommended: 'Recommended',
      startPath: 'Start Path',
      stylistUnlimited: 'Stylist Unlimited',
      stylistUnlimitedIncludes: 'Stylist Unlimited Includes',
      tryAgain: 'Try Again',
    },
    styleMeProperly: {
  ...
  privacy: {
    ...
    section01: {
      sub01: {
        ...
        bullet3: 'Content: photos, videos, outfit posts, comments, and voice recordings you share.',
      ...
      sub03: {
        body: 'We may receive information from third-party services you connect, such as social media platforms for login or sharing purposes.',
    ...
    section06: {
      body: 'To exercise these rights, contact us at privacy@dripn.app or use the in-app Settings.',
    ...
    section12: {
      emailPrivacy: 'Email: privacy@dripn.app',
      emailSupport: 'Support: support@dripn.app',
    ...
    section13: {
      ...
      sub02: {
        body: 'California residents have the right to know what personal information is collected, request deletion, and opt-out of the sale of personal information. We do not sell personal information. To exercise your rights, email privacy@dripn.app.',
  ...
  savedOutfits: {
    ...
    couldNotSaveTitle: 'Could Not Save Title',
    ...
    nothingToSaveMessage: 'Nothing To Save Message',
    nothingToSaveTitle: 'Nothing To Save Title',
    outfitColumn: 'Outfit Column',
    outfitDetails: 'Outfit Details',
    outfitSavedMessage: 'Outfit Saved Message',
    outfitSavedTitle: 'Outfit Saved Title',
    previewColumn: 'Preview Column',
    saveOutfit: 'Save Outfit',
    savedToFavoritesMessage: 'Saved To Favorites Message',
    savedToFavoritesTitle: 'Saved To Favorites Title',
  ...
  subscription: {
    ...
    cancel: {
      ...
      lossOutfitCalendar: 'Outfit calendar & event planning',
    ...
    dfy: {
      included: {
        benefitCaption: 'Occasion Ready & Full Wardrobe Setup',
        defaultCaption: 'Personal Stylist · Occasion Ready · Unlimited · Full Setup',
        ...
        featureNone1: 'Quick Start wardrobe digitisation on Personal Stylist',
        ...
        featureSprint1: '5–7 ready-to-wear looks for one occasion',
        featureSprint2: 'Upload outfit photos — stylist styles you',
        featureSprint3: '14-day styling sprint',
        featureSprint4: 'Save looks to revisit anytime',
        fullDescription: '5–7 ready-to-wear looks for your next trip or event. Upload outfit photos and your stylist styles you in a 14-day sprint.',
        fullSubtitle: 'Full Setup included',
        fullWardrobeTitle: 'Full Wardrobe Setup',
        noneDescription: 'Subscribe to unlock one included stylist setup. Personal Stylist gets Quick Start; Unlimited lets you choose Quick Start or Full Setup.',
        noneSubtitle: 'Subscribe to unlock',
        occasionReadyTitle: 'Occasion Ready',
        sprintDescription: 'Digitise your wardrobe for long-term remixing. Choose Quick Start for a fast win or Full Setup to map up to 30 items.',
        sprintSubtitle: 'Quick Start included',
      },
      ...
      occasion: {
        cta: 'Style me for this',
        description: 'Solve a specific problem, once. Upload photos of your outfits and I\'ll turn them into ready-to-wear looks for one occasion.',
        excluded1: 'Build your wardrobe system',
        excluded2: 'Edit or customize individual items',
        feature1: '14 days of styled looks you\'ll actually wear',
        feature2: 'One moment solved — work, holiday, or event',
        feature3: 'Tweaks included while your window is open',
    ...
    finePrintAnd: ' and ',
    finePrintApple: 'Subscriptions are managed through your Apple ID. Cancel anytime in Settings.',
    finePrintStripe: 'Payments processed securely by Stripe.',
    great: 'Great!',
    ...
    success: {
      ...
      goUnlimitedBody: 'Outfit calendar, unlimited wardrobe, and VIP member access',
      ...
      personalStylist: {
        ...
        check2: 'Wardrobe-aware daily advice',
        check3: 'Voice chat with your stylist',
        check4: 'Mix-and-match outfit foundations',
      ...
      stylistUnlimited: {
        ...
        check2: 'Outfit calendar & event planning',
  ...
  terms: {
    ...
    section02: {
      ...
      bullet5: 'Discover fashion deals, events, and trends.',
      bullet6: 'Subscribe to premium features for enhanced experiences.',
    ...
    section04: {
      sub01: {
        ...
        bullet2: 'Personal Stylist: Unlimited decisions, wardrobe-aware advice, video posts, and extended AI chat.',
        bullet3: 'Stylist Unlimited: Everything in Personal Stylist plus outfit calendar, unlimited wardrobe, and planning tools.',
    ...
    section05: {
      ...
      sub04: {
        body: 'Your content may be featured in curated style highlights, trend showcases, or "best of" compilations. We may overlay text, apply filters, or edit content for promotional purposes while maintaining the integrity of the original. You will be credited where reasonably practical. If you wish to opt out of promotional use, you may contact us at privacy@dripn.app to request removal from future promotional materials.',
        bullet1: 'Social media promotional reels and posts.',
        ...
        intro: 'By posting photos or videos on Dripn, you grant Dripn the right to use your content in promotional materials, including but not limited to:',
    ...
    section07: {
      ...
      sub03: {
        body: 'If you believe content on Dripn infringes your copyright, please contact us at copyright@dripn.app with the required information for a DMCA takedown notice.',
    ...
    section17: {
      emailLegal: 'Email: legal@dripn.app',
      emailSupport: 'Support: support@dripn.app',
  ...
  voiceCredits: {
    ...
    creditsAddedMessage: 'Credits Added Message',
    expires: 'Expires',
    loadingBalance: 'Loading Balance',
    mostPopular: 'Most Popular',
    needMore: 'Need More',
    partialTranslationNote: 'Partial Translation Note',
    purchaseFailed: 'Purchase Failed',
    purchased: 'Purchased',
    spokenReplies: 'Spoken Replies',
    spokenReply: 'Spoken Reply',
    thisMonth: 'This Month',
    topUpApple: 'Top Up Apple',
    topUpStripe: 'Top Up Stripe',
    topUpVoiceReplies: 'Top Up Voice Replies',
    unlimited48h: 'Unlimited48h',
    unlimited48hBadge: 'Unlimited48h Badge',
