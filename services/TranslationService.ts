...
const DEFAULT_TRANSLATIONS: Translations = {
  ...
  dfy: {
    ...
    start: {
      ...
      chooseIncludedPathDesc: 'Your plan includes one setup — pick Quick Start or Full Setup to begin.',
      choosePlanUnlock: 'Choose a plan to unlock',
      chooseSetup: 'Choose your setup',
      chooseSetupDesc:
        'One-time stylist setup — Occasion Ready for a quick win, or Full Setup to digitise your wardrobe.',
      ...
      personalStylistIncludes: 'Includes Occasion Ready (Quick Start)',
      purchase: 'Purchase',
      ...
      quickVsFullNote: 'Quick Start is a fast win when you’re short on time. Full Setup is for when you want your whole closet digitised.',
