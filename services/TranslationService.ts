...
const DEFAULT_TRANSLATIONS: Translations = {
  ...
  subscription: {
    ...
    cancel: {
      ...
      great: 'Great!',
      lossExtendedWardrobe: 'Extended wardrobe',
      lossOutfitCalendar: 'Outfit calendar',
      lossSmartSuggestions: 'Smart outfit suggestions',
      lossUnlimitedEverything: 'Unlimited everything',
      lossUnlimitedVoice: 'Unlimited voice conversations',
      lossVideoCalls: 'Video calls with members',
      lossVipAccess: 'VIP member access',
      lossVoiceConversations: 'Voice conversations with your stylist',
      lossWhiteGlove: 'White-glove stylist support',
