...
const DEFAULT_TRANSLATIONS: Translations = {
  ...
  subscription: {
    ...
    aiTopUp: {
      ...
      standardDetail: '300 AI credits',
      plusName: 'AI Top-Up Plus',
      plusDetail: '600 AI credits',
      ...
      purchaseSuccess: '+{credits} AI credits added to your allowance.',
      alreadySynced: 'Your AI credit balance is up to date.',
      verifyFailed: 'AI Top-Up purchase could not be verified. Please contact support if credits are missing.',
    },
  ...
  welcome: {
    ...
    featureLookGoodDesc: "Get a second opinion when you're unsure about an outfit or how to style it.",
    featureLookGoodTitle: 'Feel confident in what you wear',
    featureStopGuessingDesc: 'Get outfit ideas built around the clothes you actually own.',
    featureStopGuessingTitle: 'Your wardrobe, styled smarter',
    featureTalkStylistDesc: 'Ask what to wear, what works together, or how to improve an outfit.',
    featureTalkStylistTitle: 'A stylist you can talk to',
    featureWardrobeDesc: "When you can't decide what to buy, Dripn helps you choose what works for you.",
